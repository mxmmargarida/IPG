...
for m in [3]:
    ...
    #for n in [10]:
        ...
        f_LotSizing = open("LS_table.txt",'a')
        f_LotSizing.write(' & '+ str(n) +' & '+ "%0.2f" % total_time+' & '+"%0.2f" % total_iter+' & '+"%0.2f" % total_size_0+' & '+"%0.2f" % total_size_1+' & '+"%0.2f" % total_size_2+'  & '+"%0.2f" % avg_numb_back+" & "+str(numb_pNE)+" & ")
        f_LotSizing.close()
        ...
        f_LotSizing = open("LS_table.txt",'a')
        f_LotSizing.write("%0.2f" % total_time_not_dfs+' & '+"%0.2f" % total_iter_not_dfs+" & "+"%0.2f" % total_size_0_not_dfs+' & '+"%0.2f" % total_size_1_not_dfs+' & '+"%0.2f" % total_size_2_not_dfs+' & '+str(numb_pNE_not_dfs)+' & ')
        f_LotSizing.close()
