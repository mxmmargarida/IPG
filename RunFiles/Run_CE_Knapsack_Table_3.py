...
for m in [3]:
    ...
    for n in [10]:
        f_knapsack = open("CE_KP_table_3player.txt",'a')
        ...
        #for ins in [0]:
            ...
            if cpu_time_not_dfs>3600 or Profits_SGM==[]:
                ...
                total_size_2_not_dfs= total_size_2_not_dfs+ Numb_stra[2]
        ...
        f_knapsack = open("CE_KP_table_3player.txt",'a')
        f_knapsack.write(' & avg  & '+ "%0.2f" % total_time_not_dfs+' & '+"%0.2f" % total_iter_not_dfs+' & '+str(numb_ce_ne_not_dfs)+' & '+str(total_supp_ce)+" & "+"%0.2f" % total_size_0_not_dfs+' & '+"%0.2f" % total_size_1_not_dfs+' & '+"%0.2f" % total_size_2_not_dfs+' & '+"%0.2f" % decrease_ce+' \\\ \n')
        f_knapsack.close()
